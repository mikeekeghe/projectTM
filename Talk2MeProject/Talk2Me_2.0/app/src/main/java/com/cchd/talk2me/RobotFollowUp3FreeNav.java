...
public class RobotFollowUp3FreeNav extends ActivityBase
    ...
    private String strUserNameFrmExtra;
    private LinearLayout journeyImage;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_robot_follow_up3_free_nav);
...
/*        FloatingActionButton fab = (FloatingActionButton) findViewById(R.id.fab);
        ...
        if (extras != null) {
            ...
            Log.d(TAG, "my personal oncreate in free strUserNameFrmExtra is :" + strUserNameFrmExtra);
        }
    ...
    private void addListenerOnthousandNutton() {
        thousandNutton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RobotFollowUp3FreeNav.this, RobotFollowUp3Nav.class);
                intent.putExtra("USER_NAME_EXTRA", strUserNameFrmExtra);

                RobotFollowUp3FreeNav.this.startActivity(intent);
            }
        });
    }
    ...
    private void addListenerOnfreeButtonDown() {
        freeButtonDown.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RobotFollowUp3FreeNav.this, RobotFollowUp3FreeNav.class);
                intent.putExtra("USER_NAME_EXTRA", strUserNameFrmExtra);
    ...
    private void addListenerOnhighButtonDown() {
        highButtonDown.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(RobotFollowUp3FreeNav.this, RobotFollowUp3HighNav.class);
                intent.putExtra("USER_NAME_EXTRA", strUserNameFrmExtra);
    ...
    private void addListenerOnReplyButton() {
        ...
        submitButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                Intent intent = new Intent(RobotFollowUp3FreeNav.this, MainChatActivityNav.class);
                intent.putExtra("USER_NAME_EXTRA", strUserNameFrmExtra);
...
//            super.onBackPressed();
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.robot_follow_up3_free_nav, menu);
        return true;
    }
